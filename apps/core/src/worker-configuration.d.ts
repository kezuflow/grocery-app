/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: ed84234620044aec45973a7ed4402466)
...
interface __BaseEnv_Env {
	...
	TRUSTED_ORIGINS: "http://localhost:5173,http://127.0.0.1:5173,http://localhost:8787,http://127.0.0.1:8787,https://core.example.invalid";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BETTER_AUTH_URL" | "TRUSTED_ORIGINS" | "PAYMENT_PROVIDER" | "ROUTE_DISTANCE_PROVIDER" | "MAPBOX_ACCESS_TOKEN">> {}
}
