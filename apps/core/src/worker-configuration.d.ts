/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: d1fe9d7add1b06e436dd867d469e65ed)
...
interface __BaseEnv_Env {
	...
	ADMINISTRATOR_TRANSFER_SECRET?: string;
}
