/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc ./src/worker-configuration.d.ts` (hash: 4ce1e8fdbb2e691f41d32cf4cde9cb01)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BETTER_AUTH_URL" | "TRUSTED_ORIGINS" | "PAYMENT_PROVIDER" | "ROUTE_DISTANCE_PROVIDER" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "MAPBOX_ACCESS_TOKEN" | "PAYMONGO_SECRET_KEY" | "PAYMONGO_WEBHOOK_SECRET" | "LOCAL_PAYMENT_PROVIDER">> {}
}
