/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 13e6f07bf8ef48dff0404a76150170e8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "INITIAL_GLOBAL_ADMIN_EMAIL" | "BETTER_AUTH_URL" | "TRUSTED_ORIGINS" | "PAYMENT_PROVIDER" | "DELIVERY_PROVIDER" | "DELIVERY_PROVIDERS" | "ROUTE_DISTANCE_PROVIDER" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "MAPBOX_ACCESS_TOKEN" | "PAYMONGO_SECRET_KEY" | "PAYMONGO_WEBHOOK_SECRET" | "AUTH_EMAIL_FROM">> {}
}
