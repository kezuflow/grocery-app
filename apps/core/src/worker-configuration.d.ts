/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: aacd1dddcd5f056e0c4d1b25f121158f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BETTER_AUTH_URL" | "TRUSTED_ORIGINS" | "PAYMENT_PROVIDER" | "DELIVERY_PROVIDER" | "DELIVERY_PROVIDERS" | "ROUTE_DISTANCE_PROVIDER" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "MAPBOX_ACCESS_TOKEN" | "PAYMONGO_SECRET_KEY" | "PAYMONGO_WEBHOOK_SECRET" | "LOCAL_PAYMENT_PROVIDER">> {}
}
