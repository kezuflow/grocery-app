import { adminCategoryStatusBodySchema, idempotencyKeySchema } from "@freshmarkets/validation";
...
async function POSTHandler(request: Request, context: Context) {
  ...
  const body = await readBoundedJson(request, adminCategoryStatusBodySchema, { maxBytes: 16384 });
