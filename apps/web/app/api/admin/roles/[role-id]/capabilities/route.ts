...
async function PUTHandler(request: Request, context: { params: Promise<{ "role-id": string }> }) {
...
export const PUT = observeAdminRoute("admin.roles.by_role_id.capabilities.put", PUTHandler);
