...
/** Thin same-origin BFF adapter for the inventory ledger. Transport only. */
async function GETHandler(
  ...
  const result = await coreClient(env.CORE).getAdminInventoryLedger({
    requestId: webRequestId(request),
...
export const GET = observeAdminRoute("admin.inventory.by_inventory_pool_id.ledger.get", GETHandler);
