...
/** Thin same-origin BFF adapter for the reconciliation queue. */
async function GETHandler(request: Request) {
  ...
  const result = await coreClient(env.CORE).listAdminReconciliationCases({
...
export const GET = observeAdminRoute("admin.payments.reconciliation.get", GETHandler);
