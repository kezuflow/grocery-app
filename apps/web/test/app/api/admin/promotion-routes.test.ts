...
import { GET as listPromotions, POST as createPromotion } from "@/app/api/admin/promotions/route";
import {
  GET as getPromotion,
  PATCH as updatePromotion,
} from "@/app/api/admin/promotions/[promotion-id]/route";
import { POST as changeStatus } from "@/app/api/admin/promotions/[promotion-id]/status/route";
import { POST as preview } from "@/app/api/admin/promotions/[promotion-id]/preview/route";
import {
  GET as listGrants,
  POST as grant,
} from "@/app/api/admin/promotions/[promotion-id]/grants/route";
import { GET as listRedemptions } from "@/app/api/admin/promotions/[promotion-id]/redemptions/route";
