...
} from "@/app/api/admin/catalog/categories/route";
import {
  GET as getCategory,
  PATCH as updateCategory,
} from "@/app/api/admin/catalog/categories/[category-id]/route";
import { POST as categoryStatus } from "@/app/api/admin/catalog/categories/[category-id]/status/route";
import { GET as listUnits, POST as createUnit } from "@/app/api/admin/catalog/units/route";
import { GET as listProducts, POST as createProduct } from "@/app/api/admin/catalog/products/route";
import {
  GET as getProduct,
...
} from "@/app/api/admin/catalog/products/[product-id]/media/[media-id]/route";
import { GET as getProductMediaContent } from "@/app/api/admin/catalog/products/[product-id]/media/[media-id]/content/route";
import { POST as createSku } from "@/app/api/admin/catalog/skus/route";
import { PATCH as updateSku } from "@/app/api/admin/catalog/skus/[sku-id]/route";
import { PUT as setAvailability } from "@/app/api/admin/catalog/skus/[sku-id]/availability/route";
import { POST as setPrice } from "@/app/api/admin/catalog/skus/[sku-id]/price/route";
import { GET as listInventory } from "@/app/api/admin/inventory/route";
import { GET as getLedger } from "@/app/api/admin/inventory/[inventory-pool-id]/ledger/route";
