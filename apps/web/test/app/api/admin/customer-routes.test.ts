...
import { GET as getCustomer } from "@/app/api/admin/customers/[customer-id]/route";
import {
...
import { POST as privacyAction } from "@/app/api/admin/privacy-requests/[privacy-request-id]/actions/route";
