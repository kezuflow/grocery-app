...
import { GET as getDefinitions } from "@/app/api/admin/analytics/definitions/route";
import { GET as getOverview } from "@/app/api/admin/analytics/overview/route";
import { GET as getMetric } from "@/app/api/admin/analytics/metrics/[metric-code]/route";
