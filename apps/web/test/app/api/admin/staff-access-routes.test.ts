...
import { GET as getStaff, PATCH as updateStaff } from "@/app/api/admin/staff/[staff-id]/route";
import { POST as invite } from "@/app/api/admin/staff/invitations/route";
import { POST as revokeInvitation } from "@/app/api/admin/staff/invitations/[invitation-id]/revoke/route";
import { POST as changeAccess } from "@/app/api/admin/staff/[staff-id]/access/route";
import { PUT as setRoles } from "@/app/api/admin/staff/[staff-id]/roles/route";
import { PUT as setScopes } from "@/app/api/admin/staff/[staff-id]/scopes/route";
import { POST as revokeSessions } from "@/app/api/admin/staff/[staff-id]/sessions/revoke/route";
import { GET as listRoles, POST as createRole } from "@/app/api/admin/roles/route";
import { GET as getRole, PATCH as updateRole } from "@/app/api/admin/roles/[role-id]/route";
import { PUT as setCapabilities } from "@/app/api/admin/roles/[role-id]/capabilities/route";
import { POST as archiveRole } from "@/app/api/admin/roles/[role-id]/archive/route";
import { GET as capabilities } from "@/app/api/admin/capabilities/route";
