/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 3d0a03e598495f7a982c35b6606c8509)
// Runtime types generated with workerd@1.20260828.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	PUBLIC_APP_ORIGIN: "https://freshmarkets-web-staging.ilyreggie.workers.dev" | "http://localhost:3000";
	ENVIRONMENT: "staging" | "development";
	PAYMONGO_PUBLIC_KEY: "pk_test_4H9rTzNx2r6AQdxaz4LpGKJf";
	MAPBOX_BROWSER_TOKEN: string;
	CORE: Service /* entrypoint CoreEntrypoint from freshmarkets-core-staging */ | Service /* entrypoint CoreEntrypoint from freshmarkets-core */;
}
declare namespace Cloudflare {
	interface StagingEnv {
		ASSETS: Fetcher;
		PUBLIC_APP_ORIGIN: "https://freshmarkets-web-staging.ilyreggie.workers.dev";
		ENVIRONMENT: "staging";
		PAYMONGO_PUBLIC_KEY: "pk_test_4H9rTzNx2r6AQdxaz4LpGKJf";
		MAPBOX_BROWSER_TOKEN: string;
		CORE: Service /* entrypoint CoreEntrypoint from freshmarkets-core-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_ORIGIN" | "ENVIRONMENT" | "PAYMONGO_PUBLIC_KEY" | "MAPBOX_BROWSER_TOKEN">> {}
}
