/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 7330e27c8a7bc5bd7c8d8bf3cc0b37a1)
// Runtime types generated with workerd@1.20260828.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	PUBLIC_APP_ORIGIN: "https://freshmarkets.ph" | "http://localhost:3000";
	ENVIRONMENT: "staging" | "production" | "development";
	GOOGLE_MAPS_BROWSER_KEY: string;
	GOOGLE_MAPS_MAP_ID: string;
	PAYMONGO_PUBLIC_KEY: string;
	CORE: Service /* entrypoint CoreEntrypoint from freshmarkets-core-staging */ | Service /* entrypoint CoreEntrypoint from freshmarkets-core-production */ | Service /* entrypoint CoreEntrypoint from freshmarkets-core */;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		GOOGLE_MAPS_MAP_ID: string;
		PAYMONGO_PUBLIC_KEY: string;
		CORE: Service /* entrypoint CoreEntrypoint from freshmarkets-core-production */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_ORIGIN" | "ENVIRONMENT" | "GOOGLE_MAPS_BROWSER_KEY" | "GOOGLE_MAPS_MAP_ID" | "PAYMONGO_PUBLIC_KEY">> {}
}
