        ...
        <div className="flex flex-col gap-6">
          {socialPosition === "top" && (
            <>
              ...
              {showSeparator && (
                <FieldSeparator className="*:data-[slot=field-separator-content]:bg-oklch(1 0 0) text-xs flex items-center dark:*:data-[slot=field-separator-content]:bg-oklch(0.205 0 0)">
