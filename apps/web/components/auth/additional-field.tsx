  ...
  return (
    <Field>
      <div className="flex items-center justify-between gap-2">
        <FieldLabel htmlFor={name}>{field.label}</FieldLabel>
        <span className="text-sm text-oklch(0.556 0 0) tabular-nums dark:text-oklch(0.708 0 0)">
        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger
            ...
            className={cn(
              ...
              "data-[empty=true]:text-oklch(0.556 0 0) dark:data-[empty=true]:text-oklch(0.708 0 0)",
            )}
          >
        ...
        {isDateTime && (
          <Field className="w-32">
            ...
            <Input
              ...
              disabled={isPending || field.readOnly}
              className="appearance-none bg-oklch(1 0 0) [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none dark:bg-oklch(0.145 0 0)"
            />
          </Field>
        )}
      </div>
