...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex w-full items-center rounded-[var(--fm-radius-control)] border border-[var(--fm-border)] bg-white shadow-xs transition-[color,box-shadow] outline-none",
