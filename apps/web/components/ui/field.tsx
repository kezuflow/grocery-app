...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-sm leading-normal font-normal text-[var(--fm-text-muted)] group-has-[[data-orientation=horizontal]]/field:text-balance",
        "last:mt-0 nth-last-2:-mt-1 [[data-variant=legend]+&]:-mt-1.5",
        "[&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-[var(--fm-primary-dark)]",
        className,
      )}
      {...props}
    />
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className="relative mx-auto block w-fit bg-white px-2 text-[var(--fm-text-muted)]"
