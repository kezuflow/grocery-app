...
Owner correction, 2026-09-21: authorized Global Product previews directly manage the Product lifecycle, each selling option's global lifecycle, and multiple category memberships. Category order identifies the primary category used by compatibility projections. These controls do not appear in fulfillment-location previews.
