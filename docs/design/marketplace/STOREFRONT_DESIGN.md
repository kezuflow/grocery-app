...
- The in-app notification drawer surface is deferred from the immediate implementation phase; the approved launch transactional email set is scope-tracked in `PRODUCT_SCOPE.md` and delivered by the notifications feature program.
