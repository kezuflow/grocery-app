...
| Program 3 — Renewal / Trial Conversion / Dunning | canonical policy approved (D2, encoded); program spec not started | not started | — | NOT STARTED (foundations audited 2026-08-26: canonical state machine, trial grant/activation, scheduled cancellations exist from remediation; renewal/dunning/grace/authorization scope remains) |
