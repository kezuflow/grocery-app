...
| External Delivery                  | Delivery jobs, normalized progress/exceptions, typed provider capabilities, staff-selected Lalamove or Manual dispatch in both modes after packing, execution-attempt timing, quotation/booking/reconciliation, and provider dispatch observations        | Raw order-state mutation, payment/refund policy, internal fleet/Rider/batch execution, provider vocabulary outside adapters                                                              |
