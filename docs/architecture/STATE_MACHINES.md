...
Scheduled future pickup may be requested during PICKING, READY_TO_PACK or PACKING once exact paid demand has accepted cycle goods available. PACKED instead proves receipt through the immutable packing movements and also permits immediate pickup. The booking command rechecks these facts and the pickup deadline at admission; it does not consume or reserve additional goods. The saved delivery-window end bounds the pickup time. An admitted booking does not advance preparation, imply rider assignment, or rewrite the customer promise.
