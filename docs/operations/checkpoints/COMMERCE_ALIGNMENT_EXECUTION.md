...
- Branch `main`; latest verified push `695012de..93bb2ccc`, `feat(delivery): retry closed courier attempts safely`. Manual delivery, automatic Instant booking and Scheduled readiness milestones are committed and locally verified. CA-6 remains active. The weight-limit milestone is committed/pushed as `d565a640`; the retirement/no-minimum milestone is committed/pushed as `c211b83c`. The six-file missed-delivery policy milestone is committed/pushed as `796f9765`. Courier retry/recovery and GD-D15 mode switching are committed/pushed as 93bb2ccc. The active working-tree scope now records customer-agreed revised delivery times before handover. Preserve unrelated changes.
...
**One next action:** commit/push the verified customer-agreed revised-promise milestone, then implement inspected physical-return recovery. Same CA-6 / Phase 6 / section H; all remaining ledger obligations stay open.