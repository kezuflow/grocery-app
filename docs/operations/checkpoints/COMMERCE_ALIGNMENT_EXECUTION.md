...
- Branch `main`; latest verified push `37c7fe46..18fc6fa1`, `feat(delivery): inspect returned goods before redelivery`. Earlier CA-6 milestones and exact evidence remain in history. The signed-callback acceptance scope below is verified for its named milestone commit; preserve unrelated changes.
