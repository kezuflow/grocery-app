...
The visual hierarchy follows the attached [X announcement modal](https://mobbin.com/screens/a6a0ed76-312a-4d82-a585-9e1c5912cf8e): white top bar with the FreshMarkets mark centered and Close on the right, a full-width image, concise copy on white and one green action. The centered card must fit a mobile viewport with both Close and action reachable. [Grab's order action](https://mobbin.com/screens/843520c2-c0f1-4f3a-8910-4b8e65347011) informs the fully rounded button shape. The owner extended that shape to Storefront and Admin buttons; fields and other containers retain their own shapes. Grab's published [Duxton account](https://www.figma.com/customers/how-grab-scales-hyperlocal-experiences-across-southeast-asia-with-figma-and-ai/) describes configurable corner radius, not a universal public pill rule.
